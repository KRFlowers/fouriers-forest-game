...
A fun, interactive browser game where you race against the clock to smash as many cicadas as possible! Built with vanilla JavaScript and jQuery.
...
- **Score tracking** - see how many you can catch
